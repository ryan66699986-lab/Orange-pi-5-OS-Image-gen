...
Use a new repository checkout if desired, but more importantly let `build.sh` create a completely fresh versioned Armbian workspace. Record the repository commit. Do not reuse any previous workspace or artifact.
