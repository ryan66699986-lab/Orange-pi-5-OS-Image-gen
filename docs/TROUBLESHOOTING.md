...
| `ldd` reports `not found` in merged preflight or target | Build-container dependency was not packaged for runtime | Add the runtime package/artifact manifest and target/offline assertions; do not bypass the V3.21 early closure gate |
