...
| Status | active development; V3.19 corrects V3.18's early Brave APT-key validation failure and is ready for a fresh build/test |
...
See `docs/ARCHITECTURE.md`, `docs/BUILDING.md`, `docs/STATUS.md`, `docs/VALIDATION.md` and `docs/V3.19-AUDIT.md`.
